...
var MediaCardShow = /** @class */ (function (_super) {
    __extends(MediaCardShow, _super);
    function MediaCardShow(props) {
    ...
    MediaCardShow.prototype.componentDidMount = function () {
        /** 处理动画时间节点 timePoint */
    ...
    MediaCardShow.prototype.render = function () {
        /**
    ...
    return MediaCardShow;
}(React.Component));
exports.default = AnimationWrapper_1.default.control()(MediaCardShow);
