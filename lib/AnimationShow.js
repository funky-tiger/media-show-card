...
var AnimationShow = /** @class */ (function (_super) {
    ...
    AnimationShow.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null, childShowElement && (React.createElement("div", { className: isFade ? 'card-fade-out' : '' },
            React.createElement(react_motion_1.StaggeredMotion, { defaultStyles: [initPointPoint, initLinePoint, initialWidth, initialWidth, initialHeight], styles: function (styles) {
                        ...
                        switch (i) {
                            ...
                            case 1:
                                return {
                                    ...
                                    progress: react_motion_1.spring(100),
                                };
                            case 2:
