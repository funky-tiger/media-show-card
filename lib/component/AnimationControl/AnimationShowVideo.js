...
var AnimationShowVideo = /** @class */ (function (_super) {
    ...
    AnimationShowVideo.prototype.componentDidMount = function () {
        var _this = this;
        var _a = this.props, timePoint = _a.timePoint, handleToggleNextShow = _a.handleToggleNextShow;
        //监听视频播放事件
    ...
    AnimationShowVideo.prototype.render = function () {
        ...
        React.createElement("div", { style: { overflowX: "hidden", overflowY: "hidden" } },
            React.createElement("video", { ref: function (video) { return (_this.video = video); }, src: src ? src : "", autoPlay: autoPlay ? autoPlay : true, loop: loop ? loop : "loop", style: style ? style : {} })));
    };
